...
Abra o arquivo`.github/workflows/tests.yml` e observe que os testes são executados em três sistemas operacionais (Ubuntu, macOS e Windows) e várias versões da linguagem Python. Veja um exemplo em [https://github.com/andrehora/library/actions/runs/14231197771](https://github.com/andrehora/library/actions/runs/14231197771).
